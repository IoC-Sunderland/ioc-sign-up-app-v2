"""
Django settings for sign_up_app project.
...
SECRET_KEY = '^1--+r%n$^uhas(dn%&auck^s&!_7c1v!+=1v%(b1&h#5ix9-@'
...
WSGI_APPLICATION = 'sign_up_app.wsgi.application'
